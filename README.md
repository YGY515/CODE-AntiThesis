...
1) 다른 사람의 플러그인을 적용할 때 <b>에러가 생겨서</b> 수정한 코드
2) 다른 사람의 플러그인을 <b>프로젝트에 맞춰 돌아가게끔</b> 수정한 코드(오류 X, 구현에 맞춰 바꾼 것)
3) <b>필요한 기능을 구현하기 위해</b> 본인이 작성한 코드

업로드 되는 코드는 해당 세 가지 기준이며, 스크립트 파일 제목에 번호를 달아 구분하였습니다.<br>
