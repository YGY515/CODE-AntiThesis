// 해당 플러그인은 Galv님이 오픈 소스로 제작한 것으로, 지도 UI를 통해 플레이어가 맵을 이곳저곳 다닐 수 있는 플러그인임
...
Scene_MapTravel.prototype.createLocListWindow = function() {	
	this._locationListWindow = new Window_MapTravelList(0,0,Graphics.width / 5,Graphics.height - this._locationWindow.height);
...
Window_MapTravelConfirm.prototype.updatePlacement = function() {
	...
	this.y = (Graphics.height - this.height) - 95; // / 2 - 54;
};
